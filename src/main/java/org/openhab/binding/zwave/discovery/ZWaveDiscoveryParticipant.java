...
/**
 * The {@link ZWaveDiscoveryParticipant} is responsible processing the
 * results of searches for mDNS services of type _serial2tcp._tcp.local.
 *
 * @author Aitor Iturrioz - Initial contribution
 */
public class ZWaveDiscoveryParticipant implements MDNSDiscoveryParticipant {

    private Logger logger = LoggerFactory.getLogger(ZWaveDiscoveryParticipant.class);
